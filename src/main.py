...
news1 = [
    ...
    {
        "Date": "2023/6/15",
        "Title": "夜間の生物展示 (アシカ・ケープペンギン・モモイロペリカン)について",
...
def news(user:UserModel):
    ...
    time_passed = [(datetime.datetime(2023, 12, 9, 12, 0, 0, 0)-datetime.datetime.strptime(t['Date'],"%Y-%m-%d")).days for t in doc_dict_list[1:]]
