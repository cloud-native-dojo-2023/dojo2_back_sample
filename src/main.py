...
news1 = [
    ...
    {
        "Date": "2023/7/2",
        "Title": "サカバンバスピスの新グッツ限定発売決定！",
        "Description": "今年もやってきました！新グッツ限定販売が今年も開催されます．今年はサカバンバスピスをグッツ化します．お楽しみに！",
...
news2 = [
    ...
    {
        "Date":"2023/7/5", 
        "Title":"イルカの「いるか」永眠のお知らせ",
        "Description":"""本日，イルカの「いるか」が永眠いたしました．「いるか」を応援してくださったみなさまに，感謝とお礼を申しあげます．""",
